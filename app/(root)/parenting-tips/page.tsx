  ...
  const featuredArticles = [
    {
      ...
      excerpt:
        "Discover simple daily rituals that bring your family closer together...",
      readTime: "5 min",
      imageUrl:
        "https://img.freepik.com/free-vector/social-media-cover-template-international-day-families_23-2150310693.jpg?t=st=1741811594~exp=1741815194~hmac=30656058335868369a3d34fb96100f94084faec0ae4f06767115bddcfad36c6d&w=2000", // Image for this article
    },
    {
      ...
      readTime: "8 min",
      imageUrl:
        "https://img.freepik.com/free-photo/composition-delicious-thanksgiving-day-dinner_23-2149129477.jpg?t=st=1741811710~exp=1741815310~hmac=edc6f86cf59e2c213f0e4fc0ecee874e4e6418e3f8196555267345c71e0dad1a&w=1380",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {featuredArticles.map((article, index) => (
              <div
                key={index}
                className=" rounded-xl p-8 bg-[#E546E3]/10 transition-colors"
              >
          ...
          <div className="space-y-8">
            <blockquote className="bg-white p-8 rounded-xl shadow-md">
              <p className="text-gray-600 text-lg mb-4">
                The meal planning tips transformed our family dinners. Finally
      ...
      <section className="bg-gray-900 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-8">
            Get weekly expert tips and connect with other parents
          </p>
