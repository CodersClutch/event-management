    ...
    <div>
      ...
      <div className="grid  md:grid-cols-6 sm:grid-cols-3 grid-cols-2 mx-auto max-w-7xl">
        {categories.map((item, idx) => (
          ...
          >
            <div className="flex group items-center bg-gradient-to-b hover:bg-gradient-to-t from-[#A22D9E] hover:from-[#A22D9E] hover:to-[#F34CF1] to-[#F34CF1]  shadow-md transition border  border-purple-400-100 rounded-full p-10 justify-center">
