      ...
      <div className="pt-[170px] p-4 flex text-white flex-row justify-between px-[120px] items-center">
        ...
        <div className="relative w-[500px] h-[300px] rounded-lg overflow-hidden">
          <Image
            ...
            src="https://img.freepik.com/premium-photo/happy-multiracial-multigeneration-family-spending-leisure-time-yard-sunny-day_13339-309501.jpg?uid=R178129720&ga=GA1.1.1411535131.1738618804&semt=ais_hybrid"
            alt="All Ages Event"
            layout="fill"
            objectFit="cover"
          />
