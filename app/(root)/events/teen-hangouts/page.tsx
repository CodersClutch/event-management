...
const imageUrl = "https://img.freepik.com/premium-photo/multiethnic-friends-taking-selfie-with-mobile-phone-street_1048944-30149994.jpg?uid=R178129720&ga=GA1.1.1411535131.1738618804&semt=ais_hybrid"
const Page = () => {
  return (
    <div className="bg-[#351736] space-y-50">
      {/* mini hero */}
      <div className="pt-[170px] p-4 flex text-white flex-row justify-between px-[120px] items-center">
        <div className="space-y-4">
          ...
          <p className="text-sm font-semibold max-w-sm">
            Discover a world of fun and learning at the Teen hangout! From
