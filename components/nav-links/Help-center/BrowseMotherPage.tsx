...
const tabsData = [
  {
    ...
    content: (
      <div>
        <h2 className="text-[1.4rem] text-[#13002D] font-semibold mb-4">
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          ...
          <p>
            Filter events based on date, type, or popularity to refine your
            search.
          </p>
          <p>
            Check event details, including venue, time, and ticket availability.
          </p>
          <p>Save events to your wishlist for easy access later.</p>
        </div>

        <h2 className="text-[1.4rem] text-[#13002D] font-semibold my-4">
          Select your ticket
        </h2>
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Choose from different ticket types such as General, VIP, or Early
            Bird.
          </p>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Click the &quot;Register&quot; or &quot;Buy Ticket&quot; button to
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Select a payment method such as credit card, PayPal, or mobile
            wallet.
          </p>
          <p>
            Ensure payment details are accurate before confirming the
            transaction.
          </p>
        </div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Receive an email confirmation with your ticket details and QR code.
          </p>
    ...
    content: (
      <div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          ...
          <p>
            Find tickets under the My Tickets section for upcoming and past
            events.
          </p>
        </div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            If allowed, transfer your ticket to a friend by entering their
            details.
          </p>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Update your personal information, including name, email, and phone
            number.
          </p>
          <p>
            Upload or change your profile picture for a personalized experience.
          </p>
        </div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Change your password or enable two-factor authentication (2FA) for
            added security.
          </p>
          <p>
            Manage account privacy settings, including visibility and
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Save and manage your preferred payment methods for faster checkouts.
          </p>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Customize your event interests to receive personalized
            recommendations.
          </p>
          <p>
            Subscribe or unsubscribe from event notifications and newsletters.
          </p>
        </div>
    ...
    content: (
      <div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          ...
          <p>
            Unauthorized use, fraud, or violation of our policies may result in
            account suspension.
          </p>
        </div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            We collect and store user data to improve your experience while
            ensuring privacy.
          </p>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Understand our refund policies for ticket cancellations or event
            changes.
          </p>
          <p>
            Some events may have a no-refund policy, so check before purchasing.
          </p>
        </div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            Users must provide accurate information and follow event guidelines.
          </p>
          <p>
            Any misuse of the platform or violation of event rules may lead to
            penalties.
          </p>
        </div>
        ...
        <div className="text-[0.9rem] text-blue-600 space-y-2">
          <p>
            We may update our terms and policies periodically to comply with
            legal requirements.
          </p>
          <p>
            Users will be notified of major updates that affect their rights and
            responsibilities.
          </p>
        </div>
      </div>
        ...
        <div className="w-1/4 pr-4 space-y-2">
          ...
          {tabsData.map((tab, index) => (
            <button
              ...
              className={`w-full text-left py-2 px-2 text-[0.9rem] text-blue-600 flex gap-1 items-center ${
