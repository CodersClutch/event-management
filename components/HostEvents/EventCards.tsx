...
const EventCards = () => {
    return (
        <div className="min-h-screen py-8 px-4">
            <div className="max-w-3xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-y-8">
                {eventList.map(event => (
                    <div key={event.id} className="bg-white rounded-lg shadow overflow-hidden w-full lg:w-[350px] mx-auto">
                        {/* Top row: Author profile, name, and time below */}
                        <div className="p-4 text-sm text-gray-500">
                            <div className="flex items-center space-x-2">
                                <div className="relative w-9 h-9 rounded-full overflow-hidden">
                                    <Image src={event.profileImage} alt="User Profile" fill className="object-cover" />
                                </div>
                                <div className="flex flex-col">
                                    <span className="font-semibold text-[#18212C] text-[1rem]">By {event.author}</span>
                                    ...
                                    <div className="grid grid-cols-5 h-full border bg-white">
                                        ...
                                        <div className="col-span-3 relative">
                                            ...
                                            <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black to-transparent flex justify-between items-center">
                                                <span className="text-white text-xl font-semibold">{event.eventName}</span>
                                        ...
                                        <div className="col-span-2 flex flex-col">
                                            ...
                                            <div className='px-6 pt-6 border-b'>
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    />
                                                    <div>
                                                        <span className="text-[1.08rem] font-semibold text-[#050305]">By {event.author}</span>
                                                ...
                                                <p className="text-[1.06rem] text-gray-500 mb-4">
                                                    Sed egestas mauris sit amet orci dignissim, vel pulvinar nisi
                                                    faucibus. Duis gravida sem eu magna ornare, quis elementum lacus
                                                    accumsan. Vestibulum eu efficitur nisl, in fringilla sapien.
                                                </p>
                                            </div>

                                            <div className="px-6 py-3 border-b grid grid-cols-3 gap-2">
                                                <div>
                                                    <span className="text-lg text-[#050305] font-semibold">Date</span>
                                                    <p className="text-sm  text-gray-500">{event.date}</p>
                                                </div>
                                                <div>
                                                    <span className="text-lg text-[#050305] font-semibold">Location</span>
                                                    <p className="text-sm text-gray-500">{event.location}</p>
                                                </div>
                                                <div>
                                                    <span className="text-lg text-[#050305] font-semibold">Tickets</span>
                                                    <p className="text-sm text-gray-500">{event.tickets}</p>
                                                </div>
                                            </div>

                                            <div className="flex items-center px-6 py-4 border-b bg-[#F9F9F9]">
                                                <span className="text-lg font-semibold mr-2">Sponsor by</span>
                                                <div className="flex gap-1">
                                                    {event.sponsors.map((src, index) => (
                                                        <div key={index} className="relative w-10 h-10 rounded-full border-2 border-white overflow-hidden first:ml-0">
                                            ...
                                            <div className="flex justify-between px-6 py-5  items-center">
                                                <div className="flex items-center space-x-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 fill-current text-gray-400 hover:text-red-500" viewBox="0 0 20 20">
                                                ...
                                                <div className="flex items-center space-x-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 fill-current text-gray-400 hover:text-blue-500" viewBox="0 0 20 20">
                                            ...
                                            <div className="container">
                                                <div className='border-b px-6'>
                                                    <div className="flex items-center mb-4">
                                                        ...
                                                        />
                                                        <div>
                                                            <span className="text-[1.08rem] font-semibold">By John Doe</span>
                        ...
                        <div className="py-4">
                            ...
                            <div className="grid grid-cols-3 gap-2 mb-2 px-4 mt-1">
                                ...
                                <div className="flex flex-col space-y-2">
                                    ...
                                    <span className="text-xs text-[#84759E]">{event.location}</span>
                                </div>
                                <div className="flex flex-col space-y-2">
                                    <span className="font-semibold text-[#18212C]">Tickets</span>
                                    <span className="text-xs text-[#84759E]">{event.tickets}</span>
                                </div>
                            </div>
